...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "varnika");
    Lcd_cursor(&lcd, 1,1);
    Lcd_string(&lcd, "212223240170");
  /* USER CODE END 2 */
...
## Output screen shots of proteus  :
 ![lcd img](https://github.com/user-attachments/assets/8c25d694-d662-48fd-a9ed-7ddf0a8b4483)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![lcd  img ](https://github.com/user-attachments/assets/9d29cf00-d801-48ce-b9e7-8fe0bbbc54a2)
